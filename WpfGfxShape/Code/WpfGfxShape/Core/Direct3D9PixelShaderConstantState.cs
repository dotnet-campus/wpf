...
internal delegate int Direct3D9SetPixelShaderFloat4Constants(
    uint startRegister,
    ReadOnlySpan<Vector4> constants);

internal sealed class Direct3D9PixelShaderConstantState
{
    ...
    internal int SetConstants(
        uint startRegister,
        ReadOnlySpan<Vector4> constants,
        Direct3D9SetPixelShaderFloat4Constants forceSetConstants)
    {
